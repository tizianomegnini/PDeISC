document.addEventListener('DOMContentLoaded', () => {
    ...
    const methodsData = {
        push: {
            title: "push()", syntax: "array.push(element1, ..., elementN)",
            tasks: [
        ...
        unshift: {
            title: "unshift()", syntax: "array.unshift(element1, ..., elementN)",
            tasks: [
        ...
        shift: {
            title: "shift()", syntax: "array.shift()",
            tasks: [
                { desc: "Quita el primer número de un array de enteros.", init: [100, 200, 300], run: (arr) => { const el = arr.shift(); return `Elemento retirado de la posición 0: ${el}`; } },
                { desc: "Elimina el primer mensaje de un array de mensajes de chat.", init: ["Hola!", "Todo bien?", "Chau"], run: (arr) => { const el = arr.shift(); return `Mensaje procesado y purgado: "${el}"`; } },
        ...
        splice: {
            title: "splice()", syntax: "array.splice(start, deleteCount, item1, ...)",
            tasks: [
        ...
        slice: {
            title: "slice()", syntax: "array.slice(start, end)",
            tasks: [
        ...
        indexOf: {
            title: "indexOf()", syntax: "array.indexOf(searchElement, fromIndex)",
            tasks: [
        ...
        includes: {
            title: "includes()", syntax: "array.includes(searchElement, fromIndex)",
            tasks: [
        ...
        forEach: {
            title: "forEach()", syntax: "array.forEach(callback(currentValue, index, arr))",
            tasks: [
        ...
        map: {
            title: "map()", syntax: "const newArray = array.map(callback(value))",
            tasks: [
        ...
        filter: {
            title: "filter()", syntax: "const filteredArray = array.filter(callback(value))",
            tasks: [
        ...
        reduce: {
            title: "reduce()", syntax: "array.reduce(callback(accumulator, currentValue), initialValue)",
            tasks: [
        ...
        sort: {
            title: "sort()", syntax: "array.sort([compareFunction])",
            tasks: [
        ...
        reverse: {
            title: "reverse()", syntax: "array.reverse()",
            tasks: [
